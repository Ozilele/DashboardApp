...
import { getReviews, postReview, didUserPostHotelReview } from "../../controllers/client/reviewController.js";
...
router.get("/review", protect, didUserPostHotelReview);
...
router.get("/favorite/:hotelId", protect, isHotelFavorite);
